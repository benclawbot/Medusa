...
|---|---|---|---|
| Interactive terminal | `medusa` | `crates/medusa-tui` | daemon protocol v2 command, artifact, transient-event, and canonical replay authority; terminal-only presentation adapter |
