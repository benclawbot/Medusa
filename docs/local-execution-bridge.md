...
The integration branch is validated by the repository's canonical pull-request workflows before merge. Clean integration branches are rebuilt from the current default branch rather than by preserving stale stacked history.
