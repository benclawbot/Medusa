...
| Compaction manifests/summaries | `medusa-agent::compaction_v2` / derived | Never outlive source range/session | Exportable; secrets excluded | Scope-bound GC; backup cannot extend source retention | Owning session |
