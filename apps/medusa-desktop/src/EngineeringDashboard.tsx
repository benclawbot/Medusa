...
function Dashboard({ repo }: { repo: string }) {
  ...
  const act = async (id: string, action: "approve"|"reject"|"adopt"|"rollback"|"benchmark") => {
    setBusy(true);
