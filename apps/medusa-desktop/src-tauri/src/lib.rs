...
use learning_privacy::{
    runtime_delete_improvement, runtime_export_learning_audit, runtime_learning_privacy,
    runtime_redact_improvement, runtime_update_learning_privacy,
};
...
pub fn run() -> tauri::Result<()> {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            runtime_update_learning_privacy,
            runtime_redact_improvement,
            runtime_delete_improvement,
            runtime_export_learning_audit,
