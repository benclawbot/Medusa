...
checks = {
    ...
    "trusted exact-file formatting precedes verification": "prepare_components_for_verification" in read("crates/medusa-runtime/src/mutating_worker_coordinator_inner.rs"),
    ...
    "isolated implementation uses authority": "authoritative_verification_for_components_at" in read("crates/medusa-runtime/src/mutating_worker_coordinator_inner.rs"),
