...
checks = {
    ...
    "planner selects UI behavior": "UiBehavior" in read("crates/medusa-evidence/src/verification.rs"),
    "planner selects accessibility": "Accessibility" in read("crates/medusa-evidence/src/verification.rs"),
    "command outputs become receipts": "CommandReceipt::new" in read("crates/medusa-agent/src/verification_authority_backend_inner.rs"),
    "trusted exact-file formatting precedes verification": "prepare_components_for_verification" in read("crates/medusa-runtime/src/coordination/mutating_worker_coordinator_inner.rs"),
    "static UI verification is mandatory": "required_ui_verification" in read("crates/medusa-agent/src/verification.rs"),
    ...
    "isolated implementation uses authority": "authoritative_verification_for_components_at" in read("crates/medusa-runtime/src/coordination/mutating_worker_coordinator_inner.rs"),
    ...
    "scheduler validates evidence dependencies": "succeed_with_evidence" in read("crates/medusa-multi-agent-scheduler/src/inner.rs"),
