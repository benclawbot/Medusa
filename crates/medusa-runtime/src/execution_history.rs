...
fn payload_kind(payload: &EventPayload) -> &'static str {
    match payload {
        ...
        EventPayload::FileTransactionStarted { .. } => "file_transaction_started",
        EventPayload::FileTransactionProgress { .. } => "file_transaction_progress",
        EventPayload::FileTransactionRolledBack { .. } => "file_transaction_rolled_back",
