...
fn corrective_attempt_preserves_verified_partial_repairs() {
        ...
        |request| {
            ...
            match attempt {
                ...
                2 => {
                    ...
                    fs::write(request.worker.worktree.join("value.txt"), "two\n")
                        .map_err(|error| error.to_string())?;
    ...
    assert_eq!(
        ...
        vec!["src/lib.rs", "src/other.txt", "value.txt"]
    );
