...
mod tests {
    ...
    fn high_stable_confidence_allows_execution() {
        ...
        assert_eq!(
            SpikeGatePolicy::default().evaluate(&history),
            GateDecision::Execute
        );
    }
    ...
    fn low_confidence_requires_a_spike() {
        ...
        assert!(
            request
                .reasons
                .contains(&SpikeGateReason::BelowExecutionThreshold)
        );
    }
    ...
    fn sharp_recent_drop_requires_a_spike_even_above_threshold() {
        ...
        assert!(
            request
                .reasons
                .contains(&SpikeGateReason::ConfidenceCollapsed)
        );
    ...
    fn missing_history_requires_a_spike() {
        ...
        assert!(
            request
                .reasons
                .contains(&SpikeGateReason::MissingConfidence)
        );
    }
}
